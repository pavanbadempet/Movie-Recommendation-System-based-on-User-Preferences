...
def apply_learned_ranker(
    ...
    After scoring, applies contextual bandit exploration (Thompson Sampling or
    UCB) and sorts the candidates descending by ``similarity_score``.
    ...
    try:
        ...
        from backend.mmoe_ranker import get_mmoe_ranker  # noqa: F401 — kept for parity
