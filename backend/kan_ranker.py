...
class NaiveFourierKANLayer(nn.Module):
    ...
    def __init__(self, in_features, out_features, grid_size=5):
        ...
        self.fourier_coeffs_sin = nn.Parameter(torch.randn(out_features, in_features, grid_size) / math.sqrt(in_features))
        self.fourier_coeffs_cos = nn.Parameter(torch.randn(out_features, in_features, grid_size) / math.sqrt(in_features))
