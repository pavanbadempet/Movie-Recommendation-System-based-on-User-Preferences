...
def check_ratings():
    ...
    for r in rows:
        print(f"ID: {r['id']} | Type: {r['event_type']} | Movie: {r['movie_id']} | Rating: {r['rating']} | Timestamp: {r['created_at']}")
    ...
    for r in cur.fetchall():
        print(f"Event #{r['id']} | Type: {r['event_type']} | Movie ID: {r['movie_id']} | Rating: {r['rating']} | At: {r['created_at']}")
