...
def fetch_datasets():
    ...
    try:
        ...
        amazon_ds = load_dataset(
            "McAuley-Lab/Amazon-Reviews-2023", "raw_review_Electronics", split="full[:10000]", trust_remote_code=True
        )
    ...
    try:
        reddit_ds = load_dataset(
            "sentence-transformers/reddit-title-body", split="train[:10000]", trust_remote_code=True
        )
