...
class TestUtilityFunctions:
    ...
    def test_format_signals_basic(self):
        ...
        movie = {"retrieval_signals": {"genre_overlap": 0.8}, "explanation": ["genre match", "director match"]}
    ...
    def test_format_signals_empty(self):
        ...
        movie = {"retrieval_signals": {}, "explanation": []}
...
class TestDataStructures:
    ...
    def test_candidate_item_validation(self):
        ...
        candidate = {"id": 123, "title": "Test Movie", "score": 0.85, "genres": ["Action", "Drama"]}
    ...
    def test_ranked_item_sorting(self):
        ...
        items = [{"id": 1, "score": 0.5}, {"id": 2, "score": 0.9}, {"id": 3, "score": 0.7}]
...
class TestScoringFunctions:
    ...
    def test_weighted_ensemble_scoring(self):
        ...
        model_scores = {"sasrec": 0.8, "lightgcn": 0.6, "kan": 0.7}

        weights = {"sasrec": 0.5, "lightgcn": 0.3, "kan": 0.2}

        # Calculate weighted average
        ensemble_score = sum(model_scores[model] * weights[model] for model in model_scores)
    ...
    def test_boost_factor_application(self):
        ...
        base_score = 0.7
        boost_factors = {"franchise_match": 0.1, "director_match": 0.05, "quality": 0.02}
...
class TestPipelineLogic:
    ...
    def test_candidate_combination(self):
        ...
        source_a = [{"id": 1, "source": "turbovec"}, {"id": 2, "source": "turbovec"}]

        source_b = [{"id": 2, "source": "tfidf"}, {"id": 3, "source": "tfidf"}]
    ...
    def test_filter_by_threshold(self):
        ...
        items = [{"id": 1, "score": 0.9}, {"id": 2, "score": 0.5}, {"id": 3, "score": 0.7}, {"id": 4, "score": 0.3}]
...
class TestConfigurationParsing:
    ...
    def test_boolean_config_parsing(self):
        ...
        configs = {"true": True, "1": True, "yes": True, "false": False, "0": False, "no": False}
